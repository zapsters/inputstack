...
function createGameScreen() {
  console.error("CREATE GAME SCREEN FUNCTION IS DEPRECATED");
}
...
//MODULE VARIABLES ===========================================================
//module_simple_01
var var_simple01_healthPenalty = 1;

//module_reset_01
var reset_timer_graceTime = 3; //When to start flashing red.
var var_reset_01_healthPenalty = 10;
var var_reset_timerLength = 25;

//module_unscramble_01
var unscramble_timer_graceTime = 10;
var var_unscramble_healthPenalty = 10;
var var_unscramble_timerLength = 100;

//module_math_01
var var_math_01_timerLength = 60;
var var_math_01_healthPenalty = 10;
var math_01_timer_graceTime = 3;

var math_problem_list = [
  ["8 * 3", "24"],
  ["260 - 48", "212"],
  ["184 + 73", "257"],
  ["93 - 21", "72"],
...
//module_color_01
var var_color_01_timerLength = 120;
var var_color_01_healthPenalty = 10;
var color_01_timer_graceTime = 3;
var module_color_01_leniency = 50; //The leniency for a correct score. Each RGB channel must be this much close to the right answer (+ or -) for a correct.
...
function updateDebug() {
  ...
  var debug_text = [];
  //debug_vars
  for (var i = 0; i < debug_vars.length; i++) {
...
var lastShowTextForTimeRan = null;
